...
const processedVideoBucketName = "justbuster-yt-processed-videos";
 ...
 * @param processedVideoName - The name of the converted file to {@link localProcessedVideoPath}.
 * @returns A promise that resolves when the video is converted
 */
export function convertVideo(rawVideoName: string, processedVideoName: string) {
    return new Promise<void> ((resolve, reject) => {
        ffmpeg(`${localRawVideoPath}/${rawVideoName}`)
        .outputOption("-vf", "scale=-1:360") //Scaling video to 360p
        .on('end', () => {
